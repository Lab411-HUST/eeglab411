...
//JNIEXPORT jdouble JNICALL Java_com_lab411_emotionsignalgraph_Filter_gethfd(
//		JNIEnv *env, jclass cls, jdoubleArray arrXn, int N) {
//	double *arr1 = (*env)->GetDoubleArrayElements(env, arrXn, NULL);
//	int K = kMax(N);
//		int i, k, m;
//		double fd, Lmki, Ng;
//		double *lgLk = (double*) malloc(K * sizeof(double));
...
//		free(lgLk);
//		free(lgk);
//	//jdouble hfd_v = hfd(arr1,N);
//	return fd;
//}
/* Calculate hfd function */
JNIEXPORT jdouble JNICALL Java_com_lab411_emotionsignalgraph_Filter_gethfd(JNIEnv *env, jobject obj,
