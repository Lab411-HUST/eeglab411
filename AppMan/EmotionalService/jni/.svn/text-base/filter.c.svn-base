...
JNIEXPORT jdoubleArray JNICALL Java_lab411_eeg_emotionalservice_Calculate_getYnFilter(
...
JNIEXPORT jdouble JNICALL Java_lab411_eeg_emotionalservice_Calculate_getmean(
		JNIEnv *env, jclass cls, jintArray arrXn, int xnSize, int hnSize,
		double W1, double W2, double b) {
	//jdoubleArray arrXnFilter;
	//arrXnFilter = (*env)->NewDoubleArray(env, xnSize);
