...
#include <openvibe/include/openvibe/ov_all.h>
#include <toolkit/include/toolkit/ovtk_all.h>

#include <modules/xml/include/xml/IWriter.h>
#include <modules/xml/include/xml/IReader.h>
#include <openvibe/include/openvibe/ovCMemoryBuffer.h>
#include <stack>
using namespace cv;
using namespace std;
...
#define OVP_ClassId_Algorithm_ClassifierLDA                     1      //             OpenViBE::CIdentifier(0xD7183FC7, 0xBD74F298)
#define OVP_ClassId_Algorithm_ClassifierLDADesc                  1        //          OpenViBE::CIdentifier(0xD42D544A, 0x7A28DDB1)
...
namespace OpenViBEPlugins
{
	namespace Local
	{
		...
		public:
			...
			virtual OpenViBE::boolean train(const OpenViBEToolkit::IFeatureVectorSet&
					rFeatureVectorSet);
