...
{
	class OV_API CAlgorithmScenarioExporter : public OpenViBEToolkit::TAlgorithm < OpenViBE::Plugins::IAlgorithm >
	{
	public:
	...
	class OV_API CAlgorithmScenarioExporterDesc : public OpenViBE::Plugins::IAlgorithmDesc
	{
	public:
