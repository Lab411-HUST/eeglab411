...
namespace OpenViBEPlugins
{
	namespace SignalProcessingGpl
	{
		...
		protected:
              vector<double> m_vecDenomCoefFilter;
              vector<double> m_vecNumCoefFilter;
			//Vec m;// m_vecDenomCoefFilter;
			//std::vector m_vecNumCoefFilter;
			//vector<itpp::vec> m_oCurrentStates;
